  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden">
      ...
      <div className="h-32 bg-gradient-to-r from-[#72bbbc] to-[#118295]">
        {/* Você poderia colocar uma imagem de capa aqui: <img /> */}
      </div>
      ...
      <div className="p-6 relative">
        ...
        <div className="text-center mt-15">
          <h2 className="text-2xl font-bold text-gray-800">{profileData.displayName || profileData.username}</h2>
          ...
          <div className="mt-2">
            <div className="flex flex-wrap justify-center gap-2">
              {profileData.badges.map((badge, index) => (
                <span key={index} className="bg-cyan-100 text-cyan-800 text-xs font-bold px-3 py-1 rounded-full">
                  {badge}
                </span>
              ))}
            </div>
