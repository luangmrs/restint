  ...
  return (
    <div className="min-h-screen bg-gray-200">
      ...
      <main className="container mx-auto mt-8 max-w-4xl">
        ...
        <Profile key={userId} targetUserId={userId} />

        <div className="mt-8">
          <h2 className="text-xl font-bold mb-4 border-b pb-2">Publicações</h2>
          {loadingPosts ? (
          ...
          {!loadingPosts && posts.length === 0 && (
            <p className="text-center text-gray-500 mt-8">Este usuário ainda não publicou nada.</p>
          )}
        </div>
      </main>
    </div>
